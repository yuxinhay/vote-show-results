...
const ROLES = [
  { id: 'product_sponsor', label: 'Product Sponsor' },
  { id: 'hustler', label: 'Hustler (Product Manager)' },
  { id: 'hipster', label: 'Hipster (Designer)' },
  { id: 'hacker', label: 'Hacker (Developer)' },
];
      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="flex items-start space-x-3">
            ...
            />
            <Label htmlFor="acknowledge" className="cursor-pointer font-normal text-sm leading-relaxed">
              I understand the commitment required and have informed my supervisor before submitting my interest.
            </Label>
          </div>
        </div>
        ...
        <DialogFooter>
          ...
          <Button 
            ...
            disabled={isSubmitting || selectedRoles.length === 0 || !acknowledged}
          >
